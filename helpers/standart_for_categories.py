...
def filter_params():
    """
        Retrieve and filter parameters for categories, subcategories, and cart items.
        This function gathers all categories, subcategories, and sub-subcategories from the database.
        It also attempts to retrieve cart items for the currently authenticated user, if any, and 
